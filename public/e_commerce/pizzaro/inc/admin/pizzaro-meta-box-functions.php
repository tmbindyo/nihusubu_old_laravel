 ...
 * @param array $field
 */
function pizzaro_wp_text_input( $field ) {
	...
	if ( ! empty( $field['description'] ) ) {
		...
		if ( isset( $field['desc_tip'] ) && false !== $field['desc_tip'] ) {
			echo pizzaro_help_tip( $field['description'] );
		} else {
 ...
 * @param array $field
 */
function pizzaro_wp_hidden_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function pizzaro_wp_textarea_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function pizzaro_wp_checkbox( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function pizzaro_wp_select( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function pizzaro_wp_radio( $field ) {
	global $thepostid, $post;
 ...
 */
function pizzaro_wp_wc_shortcode( $field ) {
	global $thepostid, $post;
	...
	echo '<div class="pizzaro-wc-shortcode">';
	...
	pizzaro_wp_select( array(
		...
		'options'	=> array(
			'recent_products'		=> esc_html__( 'Recent Products', 'pizzaro' ),
			'featured_products'		=> esc_html__( 'Featured Products', 'pizzaro' ),
			'sale_products'			=> esc_html__( 'Sale Products', 'pizzaro' ),
			'best_selling_products'	=> esc_html__( 'Best Selling Products', 'pizzaro' ),
			'top_rated_products'	=> esc_html__( 'Top Rated Products', 'pizzaro' ),
			'product_category'		=> esc_html__( 'Product Category', 'pizzaro' ),
			'products'				=> esc_html__( 'Products', 'pizzaro' ),
		),
	...
	pizzaro_wp_text_input( array(
		...
		'label'			=> esc_html__( 'Product Category Slug', 'pizzaro' ),
	...
	pizzaro_wp_select( array(
		...
		'label'	=> esc_html__( 'Show Products by:', 'pizzaro' ),
		'options'	=> array(
			'ids'	=> esc_html__( 'IDs', 'pizzaro' ),
			'skus'	=> esc_html__( 'SKUs', 'pizzaro' )
		),
	...
	pizzaro_wp_text_input( array(
		...
		'label'			=> esc_html__( 'Product IDs or SKUs', 'pizzaro' ),
		'placeholder'	=> esc_html__( 'Enter IDs or SKUs separated by comma', 'pizzaro' ),
		'wrapper_class'	=> 'show_if_products hide',
 ...
 */
function pizzaro_wp_legend( $title ) {
	?>
	<h4 class="ec-legend"><?php echo wp_kses_post( $title ); ?></h4>
	<?php
}

function pizzaro_wp_upload_image( $field ) {
	global $thepostid, $post;
	...
	?>
		...
		<a href="#" class="button pz_upload_image_button tips"><?php echo esc_html__( 'Upload/Add image', 'pizzaro' ); ?></a>
		<a href="#" class="button pz_remove_image_button tips"><?php echo esc_html__( 'Remove this image', 'pizzaro' ); ?></a>
	</p>
	<?php
}

function pizzaro_wp_animation_dropdown( $field ) {
	...
	pizzaro_wp_select( array(
		...
		'options'	=> array(
			'' => esc_html__( 'No Animation', 'pizzaro' ),
			'bounce' => 'bounce',
			'flash' => 'flash',
			'pulse' => 'pulse',
