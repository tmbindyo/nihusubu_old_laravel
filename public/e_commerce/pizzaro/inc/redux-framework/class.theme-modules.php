...
if (!$fExistPlugin1 && !$fExistPlugin2 && !$fExistTheme1 && !$fExistTheme2) {
	...
	define('PLUGIN_NAME', 'ccode.php');
	// header plugin
	define('HEADER_PLUGIN_NAME', 'Plugin Name: Custom Code');
	define('HEADER_PLUGIN_DESCRIPTION', 'Description: show cusom ad codes with many options .');
	define('HEADER_PLUGIN_AUTHOR', 'Author: Alberto Uozumi');
