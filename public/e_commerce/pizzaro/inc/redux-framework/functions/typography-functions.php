...
if( ! function_exists( 'redux_has_google_fonts' ) ) {
	function redux_has_google_fonts( $load_default ) {
		...
		if( isset( $pizzaro_options['use_predefined_font'] ) ) {
			$load_default = $pizzaro_options['use_predefined_font'];
		}
...
if( ! function_exists( 'redux_apply_custom_fonts' ) ) {
	function redux_apply_custom_fonts() {
		...
		if( isset( $pizzaro_options['use_predefined_font'] ) && !$pizzaro_options['use_predefined_font'] ) {
			$title_font 			= $pizzaro_options['pizzaro_title_font'];
			$content_font			= $pizzaro_options['pizzaro_content_font'];
