...
<head>
    <meta charset="utf-8">
    <title>Customer Display | SimplePOS</title>
...
<div class="wrap">
        ...
        <div id="totals">
            <table style="width:100%; float:right; padding:5px; color:#000; background: #FFF;" id="totalTable">
                ...
                <tr>
                    ...
                    <td style="padding-left:10px; text-align:left; font-weight:normal;">Order Tax</td>
    ...
    <div class="main">
        <div class="content">
            ...
            <iframe class="preview_frame" src="http://127.0.0.1:3000/pos/promotions" name="preview-frame"
