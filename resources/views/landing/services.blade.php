...
@section('content')
        <!--========== PROMO BLOCK ==========-->
        <section class="s-video-v2__bg" data-vidbg-bg="mp4: {{ asset('landing') }}/include/media/mp4_video.mp4, webm: include/media/webm_video.webm, poster: include/media/fallback.jpg" data-vidbg-options="loop: true, muted: true, overlay: false">
                        ...
                        <div class="s-portfolio__item cbp-item motion graphic">
                            ...
                            <div class="s-portfolio__caption-hover--cc">
                                ...
                                <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                    ...
                                    <li>
                                        <a href="{{ asset('landing') }}/https://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes" class="s-icon s-icon--sm s-icon s-icon--white-bg g-radius--circle">
                                            <i class="ti-link"></i>
                                        </a>
                                    </li>
                                </ul>
        ...
        <!-- Counter -->
        <div class="js__parallax-window" style="background: url({{ asset('landing') }}/img/1920x1080/02.jpg) 50% 0 no-repeat fixed;">
