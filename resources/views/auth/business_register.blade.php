        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="ibox-content">
                ...
                <form id="form" action="{{ route('business.store.account') }}" method="post" class="wizard-big">
                    ...
                    <input id="acceptTerms" name="acceptTerms" type="checkbox" class="required"> <label for="acceptTerms">I agree with the <a href="{{route('terms.and.conditions')}}">Terms and Conditions</a>.</label>
