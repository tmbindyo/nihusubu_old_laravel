...
@section('content')
                    ...
                    <tr>
                        ...
                        <td class="display-block padding" width="40%" align="center" valign="middle">
                            <table class="text-center" align="left" border="0" cellpadding="0" cellspacing="0" width="120" style="border-collapse: collapse;">
                                <tbody>
                                    @foreach($data->sale->saleProducts as $saleProduct)
                                        <tr>
                                    ...
                                    @foreach($data->sale->saleProducts as $saleProduct)
                                       ...
                                       <tr>
                                           <td class="text-center" width="100%" align="right" valign="middle" style="margin:0px; padding:0px; padding-top:3px; font-size:12px; color:#969696; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; font-weight:normal;">
                                               {{$data->sale->institution->currency->name}} {{$saleProduct->rate}}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center" width="100%" align="right" valign="middle" style="margin:0px; padding:0px; font-size:12px; color:#000000; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; font-weight:normal;">
                                                {{$data->sale->institution->currency->name}} {{$saleProduct->amount}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
    ...
    <tr>
        <td width="100%" align="center" valign="middle" style="margin:0px; padding:0px; font-size:22px; color:#000000; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; font-weight:bold;">Price : {{$data->sale->institution->currency->name}} {{$data->sale->total}}</td>
    </tr>
    <tr>
        <td width="100%" height="10" style="line-height:1px;"></td>
    </tr>
    <tr>
        <td width="100%" align="center" valign="middle" style="margin:0px; padding:0px; font-size:14px; color:#000000; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; font-weight:bold;">Order ID #{{$data->sale->reference}} l Date {{$data->sale->date}}</td>
    </tr>
    <tr>
        <td class="display-block padding" width="100%" height="31" style="line-height:1px;"></td>
    </tr>
    <tr>
        <td width="100%" align="center" valign="middle" style="margin:0px; padding:0px; font-size:12px; color:#000000; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; font-weight:normal;"> {!! $data->body !!}.</td>
    </tr>
    <tr>
                ...
                <tbody>
                    <tr>
                        <td width="100%" align="center" style="max-width:255px; margin:0px; padding: 8px 20px; font-size:14px; color:#FFFFFF; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; font-weight:normal;">
                             <a href="http://www.nihusubu.com/view/order/{{$data->sale->id}}" target="_blank" style="width:100%; color:#FFFFFF; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; text-decoration:none; display:block;">View order</a>
                        </td>
                    </tr>
                </tbody>
            </table>
