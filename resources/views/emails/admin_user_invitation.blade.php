...
@section('content')
    ...
    <tr>
        <td width="100%" align="center" valign="middle" style="margin:0px; padding:0px; font-size:18px; color:#000000; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; font-weight:bold; line-height:30px;">You have been invited to be a Nihusubu Admin <br>on Nihusubu</td>
    </tr>
    <tr>
            ...
            <table class="width_90percent" align="center" border="0" cellpadding="0" cellspacing="0" width="255" style="border-collapse:collapse; max-width:100%; -webkit-border-radius:30px; border-radius:30px;" bgcolor="#ffc600">
                ...
                <tr>
                    <td width="100%" align="center" style="max-width:255px; margin:0px; padding: 8px 40px; font-size:14px; color:#FFFFFF; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; font-weight:normal; text-transform:capitalize;">
                        <a href="http://localhost:8080/user/{{encrypt($userAccount->user->id)}}/admin/invitation" target="_blank" style="width:100%; color:#FFFFFF; font-family: 'Open Sans', Helvetica, Arial, Verdana, sans-serif; text-decoration:none; display:block;">View Now</a>
                    </td>
                </tr>
                </tbody>
            </table>
