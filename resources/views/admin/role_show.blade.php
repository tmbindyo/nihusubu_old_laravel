    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-5">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong><a href="{{route('admin.roles')}}">Roles</a></strong>
                </li>
                <li class="active">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-1">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form method="post" action="{{ route('admin.role.update',$role->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                                @csrf
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="has-warning">
                                                        ...
                                                        @endif
                                                        <input type="text" id="name" name="name" required="required" value="{{$role->name}}" class="form-control input-lg {{ $errors->has('name') ? ' is-invalid' : '' }}">
                                                        <i>name</i>
                                                    </div>
                            ...
                            <div class="tab-pane" id="tab-2">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form method="post" action="{{ route('admin.user.assign.role',encrypt($role->id)) }}" autocomplete="off" class="form-horizontal form-label-left">
                                                @csrf
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                @can('user revoke role')
                                                    <a href="{{ route('admin.user.revoke.role', ['id'=>encrypt($user->id), 'role_id'=>encrypt($role->id)]) }}" class="btn-success btn-danger btn btn-xs">Revoke</a>
                                                @endcan
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                @foreach($permissions as $permission)
                                    <div class="col-sm-2">
                                        <div class="checkbox checkbox-primary">
                                            <input class="updateRolePermission" data-permission_id="{{encrypt($permission->id)}}" data-role_id="{{encrypt($role->id)}}" id="{{$permission->name}}" type="checkbox" @if(in_array($permission->name, $rolePermissionNames)) checked="true" @endif >
...
@section('js')
    ...
    <script>
        $('.updateRolePermission').on('click',function(){
            ...
            // admin/{portal}/role/update/{role_id}/permission/{permission_id}
            //send value by ajax to server
            var xhr = new XMLHttpRequest();
            xhr.open("GET", '{{url('admin')}}'+'/role/update/'+role_id+'/permission/'+permission_id);
