    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-md-3">
            <div class="title-action">
                <a href="{{route('personal.contact.create')}}" class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> Contact</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-8 col-md-offset-2">
                                <p>Edit.</p>
                                <form method="post" action="{{ route('personal.contact.type.update',$contactType->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    @csrf
                            ...
                            <tbody>
                                @foreach($contactContactTypes as $contactContactType)
                                    <tr class="gradeX">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <a href="{{ route('personal.contact.show', $contactContactType->id) }}" class="btn-white btn btn-xs">View</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
