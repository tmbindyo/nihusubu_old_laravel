...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
            <h2>Investment Create</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="{{route('personal.dashboard')}}">Home</a>
                </li>
                <li>
                    <a href="{{route('personal.investment')}}">Investment</a>
                </li>
                <li class="active">
                    <strong>Create Investment</strong>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="">
                            <form method="post" action="{{ route('personal.investment.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="has-warning">
                                            <label>  </label>
                                            <input type="text" id="investment_name" name="investment_name" required="required" class="form-control input-lg" placeholder="Investment name">
                                            <i>Give your investment a name</i>
                                        </div>
                                        {{--  investment amount  --}}
                                        <div class="">
                                            <label>  </label>
                                            <input type="number" id="investment_amount" name="investment_amount" required="required" class="form-control input-lg" placeholder="Investment amount">
                                ...
                                <div class="">
                                    ...
                                    <label>  </label>
                                    <textarea rows="5" placeholder="Investment description" class="form-control input-lg"></textarea>
                                </div>
                                <hr>
