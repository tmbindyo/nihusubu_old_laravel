...
@section('title', 'Chama Penalty Create')
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>Penalty Registration <small>Form</small></h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('personal.chama.penalty.store',$chama->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="has-warning">
                                        <input type="number" id="amount" name="amount" value="1" required="required" placeholder="Penalty" class="form-control input-lg">
                                        <i>penalty</i>
                                    </div>
                                    <br>
                                    <div class="has-warning">
