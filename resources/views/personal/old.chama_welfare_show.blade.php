    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-7">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="{{route('personal.chama.welfares',$chama->id)}}">Penalty's</a>
                </li>
                <li class="active">
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <form method="post" action="{{ route('personal.chama.welfare.update',['chama_id'=>$chama->id,'welfare_id'=>$welfare->id]) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    ...
                                    <div class="has-warning">
                                        <input type="number" id="amount" name="amount" value="1" required="required" value="{{$welfare->welfare}}" class="form-control input-lg">
                                        <i>welfare</i>
                                    </div>
                                    <br>
                                    <div class="has-warning">
                                    ...
                                    <div class="has-warning">
                                        <select name="account" class="select2_demo_account form-control input-lg" readonly>
                                            @foreach ($accounts as $chamaAccount)
                                                <option @if($chamaAccount->id == $welfare->account_id) selected @endif value="{{$chamaAccount->id}}">{{$chamaAccount->name}} [{{$chamaAccount->balance}}]</option>
                                            @endforeach
                                        </select>
                                        <i>account</i>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <dl class="dl-horizontal">
                                        <dt>Status:</dt> <dd><span class="label {{$welfare->status->label}}">{{$welfare->status->name}}</span></dd>
                                    </dl>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-5">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt>Created by:</dt> <dd>{{$welfare->user->name}}</dd>
                                    </dl>
                                </div>
                                <div class="col-lg-7" id="cluster_info">
                                    <dl class="dl-horizontal" >

                                        <dt>Last Updated:</dt> <dd>{{$welfare->updated_at}}</dd>
                                        <dt>Created:</dt> <dd> {{$welfare->created_at}} </dd>
                                    </dl>
                                </div>
                            </div>
