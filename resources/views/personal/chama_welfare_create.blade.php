            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('personal.chama.welfare.store',$chama->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="has-warning">
                                        <input type="number" id="amount" name="amount" value="1" required="required" placeholder="Welfare" class="form-control input-lg">
                                        <i>welfare</i>
                                    </div>
                                    <br>
                                    <div class="has-warning">
                                        <textarea rows="3" type="number" id="reason" name="reason" required="required" placeholder="Reason" class="form-control"></textarea>
                                        <i>reason</i>
                                    </div>
                                    <br>
                                    ...
                                    <div class="has-warning">
                                        <select name="welfare_type" class="select2_demo_welfare_type form-control input-lg">
                                            ...
                                            @foreach ($welfareTypes as $welfareType)
                                                <option value="{{$welfareType->id}}">{{$welfareType->name}}</option>
                                            @endforeach
                                        </select>
                                        <i>welfare type</i>
                                    </div>
