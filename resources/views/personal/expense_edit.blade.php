            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <div class="">
                            <form method="post" action="{{ route('personal.expense.update',$expense->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="has-warning">
                                            <div class="has-warning">
                                                <select name="sale" class="select-2 form-control input-lg">
