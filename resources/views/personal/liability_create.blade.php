            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('personal.liability.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="has-warning">
                                                <input type="number" id="interest" name="interest" oninput="getPercentAmount();" required="required" value="1.0" max="100" step="0.00001" class="form-control input-lg">
