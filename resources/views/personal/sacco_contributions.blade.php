...
@section('title', 'Sacco Contributions')
...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-4">
        <div class="title-action">
            <a href="{{route('personal.sacco.contribution.create',1)}}" class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> New </a>
        </div>
    </div>
</div>
                ...
                <div class="ibox-content">
                    ...
                    <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="btn-group">
                                    <a href="{{route('personal.sacco.contribution.delete',1)}}" class="btn-danger btn-outline btn btn-xs">Delete</a>
                                </div>
                            </td>
                        </tr>
