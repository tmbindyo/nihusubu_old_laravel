...
@section('title', 'Chama Share Payment Create')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Share Payment Create</strong>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>Shares Payment Registration <small>Form</small></h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('personal.chama.share.payment.store',$chama->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                @csrf
