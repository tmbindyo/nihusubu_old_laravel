    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-7">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="{{route('personal.chama.meetings',$chama->id)}}">Share Payment's</a>
                </li>
                <li class="active">
                    <strong>Share Payment</strong>
                </li>
            </ol>
        </div>
        <div class="col-md-5">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Share Payment <small>edit</small></h5>

                    </div>
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('personal.chama.share.payment.update',['chama_id'=>$chama->id,'meeting_id'=>$sharePayment->id]) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    @csrf
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="has-warning">
                                        <input type="number" id="shares" oninput="getShaveValue();" name="shares" value="{{$sharePayment->shares}}" required="required"  class="form-control input-lg" readonly>
                                        <i>shares</i>
                                    </div>
                                    <br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="has-warning">
                                                <input type="number" id="share_value" name="share_value" required="required" value="{{$sharePayment->value}}" class="form-control input-lg" readonly>
                                                <i>share value</i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="has-warning" id="data_1">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" required="required" name="date" id="date" value="{{$sharePayment->date}}" class="form-control input-lg">
                                        </div>
                                        <i>date joined</i>
                                    ...
                                    <div class="has-warning">
                                        <select name="account" class="select2_demo_account form-control input-lg">
                                            @foreach ($accounts as $account)
                                                <option @if($sharePayment->account_id == $account->id) selected @endif value="{{$account->id}}">{{$account->name}} [{{$account->balance}}]</option>
                                            @endforeach
                                        </select>
                                        <i>account</i>
                                    </div>
                                    ...
                                    <div class="has-warning">
                                        <select name="member" class="select2_demo_chama_member form-control input-lg">
                                            ...
                                            @foreach ($chamaMembers as $chamaMember)
                                                <option @if($sharePayment->member_id == $chamaMember->id) selected @endif value="{{$chamaMember->id}}">{{$chamaMember->name}} [{{$chamaMember->chama_member_role->name}}]</option>
                                            @endforeach
                                        </select>
                                        <i>member</i>
                                    </div>
