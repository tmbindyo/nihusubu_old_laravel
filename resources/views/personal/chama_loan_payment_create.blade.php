            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('personal.chama.loan.payment.store',['chama_id'=>$chama->id,'loan_id'=>$loan->id]) }}" autocomplete="off" class="form-horizontal form-label-left">
                                @csrf
