                ...
                <form method="post" action="{{ route('personal.to.do.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="has-warning">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input name="is_chama_member" type="checkbox" class="js-switch_2" checked />
                                    <br>
                                    <i>Check if it belongs to a chama member.</i>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="has-warning">
                                <select name="chama_member" class="select2_demo_2 form-control input-lg">
                                    <option>Select Withdrawal</option>

                                    <option value="{{$chamaMember->id}}" selected>{{$chamaMember->name}}</option>
                                </select>
                                <i>What chama member does the to do belong to</i>
                            </div>
                        </div>
                    </div>
