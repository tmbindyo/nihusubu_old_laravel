                ...
                <form method="post" action="{{ route('personal.to.do.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="has-warning">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input name="is_liability" type="checkbox" class="js-switch_2" checked />
                                    <br>
                                    <i>Check if it belongs to a Liability.</i>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="has-warning">
                                <select name="liability" class="select2_demo_2 form-control input-lg">
                                    <option>Select Liability</option>

                                    <option value="{{$liability->id}}" selected>{{$liability->reference}}</option>
                                </select>
                                <i>What liability does the to do belong to</i>
                            </div>
                        </div>
                    </div>
