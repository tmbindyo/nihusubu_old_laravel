    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-7">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="{{route('personal.chama.penalties',$chama->id)}}">Penalty's</a>
                </li>
                <li class="active">
        ...
        <div class="col-md-5">
            <div class="title-action">
                <a href="{{route('personal.chama.member.show',['chama_id'=>$chama->id,'member_id'=>$penalty->member_id])}}" class="btn btn-primary btn-outline"><i class="fa fa-eye"></i> Member </a>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Penalty <small>edit</small></h5>

                    </div>
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <form method="post" action="{{ route('personal.chama.penalty.update',['chama_id'=>$chama->id,'penalty_id'=>$penalty->id]) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    @csrf
                                    ...
                                    <div class="has-warning">
                                        <input type="number" id="amount" name="amount" value="1" required="required" value="{{$penalty->penalty}}" class="form-control input-lg">
                                        <i>penalty</i>
                                    </div>
                                    <br>
                                    <div class="has-warning">
                                        <textarea rows="3" type="number" id="reason" name="reason" required="required" class="form-control">{{$penalty->reason}}</textarea>
                                        <i>reason</i>
                                    </div>
                                    <br>
                                    <div class="has-warning" id="data_1">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" required="required" name="date" id="date" value="{{$penalty->date}}" class="form-control input-lg">
                                        </div>
                                        <i>date joined</i>
                                    ...
                                    <br>
                                    <div class="has-warning">
                                        <select name="account" class="select2_demo_account form-control input-lg" readonly>
                                            @foreach ($accounts as $chamaAccount)
                                                <option @if($chamaAccount->id == $penalty->account_id) selected @endif value="{{$chamaAccount->id}}">{{$chamaAccount->name}} [{{$chamaAccount->balance}}]</option>
                                            @endforeach
                                        </select>
                                        <i>account</i>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <dl class="dl-horizontal">
                                        <dt>Status:</dt> <dd><span class="label {{$penalty->status->label}}">{{$penalty->status->name}}</span></dd>
                                    </dl>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-5">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt>Created by:</dt> <dd>{{$penalty->user->name}}</dd>
                                    </dl>
                                </div>
                                <div class="col-lg-7" id="cluster_info">
                                    <dl class="dl-horizontal" >

                                        <dt>Last Updated:</dt> <dd>{{$penalty->updated_at}}</dd>
                                        <dt>Created:</dt> <dd> {{$penalty->created_at}} </dd>
                                    </dl>
                                </div>
                            </div>
