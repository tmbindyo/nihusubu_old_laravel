                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        ...
                                        <div class="radio radio-inline">
                                            <input type="radio" id="variable" value="variable" name="is_variable" checked="">
                                            <label for="variable"> Variable </label>
                                        </div>
                                        <div class="radio radio-inline">
                                            <input type="radio" id="fixed" value="fixed" name="is_variable">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="checkbox checkbox-info">
                                                    <input id="is_debit" name="is_debit" type="checkbox" checked>
                                                    <label for="is_debit">
                                                        Debit
                                                    </label>
                                                    <span><i data-toggle="tooltip" data-placement="right" title="Check this option if the income should be debited." class="fa fa-2x fa-question-circle"></i></span>
                                                </div>
                                                <i>Debit income</i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="checkbox checkbox-info">
                                                    ...
                                                    <span><i data-toggle="tooltip" data-placement="right" title="Check this option if the income stream is recurring." class="fa fa-2x fa-question-circle"></i></span>
                                                </div>
                                                <i>Recurring income</i>
                                            </div>
                                            <div class="col-md-9">
                                        ...
                                        {{--  income name  --}}
                                        <div class="has-warning">
                                            <input type="text" id="name" name="name" required="required" class="form-control input-lg" placeholder="Income name">
                                        ...
                                        {{--  income amount  --}}
                                        <div class="has-warning">
                                            <input type="number" id="amount" name="amount" required="required" class="form-control input-lg" placeholder="Income amount">
                                        ...
                                        {{--  Income type  --}}
                                        <div class="has-warning">
                                            <select name="income_type" class="select-2 form-control input-lg">
                                        ...
                                        <div class="has-warning">
                                            {{--  Income description  --}}
                                            <textarea rows="5" name="description" placeholder="Income description" class="form-control input-lg"></textarea>
                                        </div>
                                    </div>
