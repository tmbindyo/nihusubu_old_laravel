                                                                ...
                                                                @if($product->is_service == 0)
                                                                    ...
                                                                    @else
                                                                        @foreach($product->inventory as $inventory)
                                                                            <option value="{{$product->id}}:{{$inventory->id}}" data-product-quantity = "{{$inventory->quantity}}" data-product-selling-price = "{{$product->taxed_selling_price}}">{{$product->name}} [{{$inventory->warehouse->name}}: {{$inventory->quantity}}]</option>
                                                                        @endforeach
                                                                    @endif
                                                                @else
                                                                    <option value="{{$product->id}}" data-product-quantity = "-20" data-product-selling-price = "{{$product->taxed_selling_price}}">{{$product->name}}</option>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-md-offset-9">
                                                ...
                                                <i>Adjustment</i> <span><i data-toggle="tooltip" data-placement="right" title="Add any other +ve or -ve charges that need to be applied to adjust the total amount of the transaction." class="fa fa-x text-warning fa-question-circle"></i></span>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
