    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-6">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('business.estimate.show', ['portal'=>$institution->portal, 'id'=>$sale->id]) }}">Estimate</a>
                </li>
                <li class="active">
                    ...
                    <form class="form-horizontal" method="post" action="{{ route('business.sale.send',['portal'=>$institution->portal,'sale_id'=>$sale->id]) }}">
                        ...
                        <div class="mail-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="subject" type="text" class="form-control {{ $errors->has('subject') ? ' is-invalid' : '' }}" value="Estimate ref #{{$sale->reference}}">
                                </div>
                            </div>
                        </div>
