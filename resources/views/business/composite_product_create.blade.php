                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="has-warning">
                                            ...
                                            @endif
                                            <input type="text" id="product_name" name="product_name" value="{{ old('product_name') }}" required="required" class="form-control input-lg {{ $errors->has('product_name') ? ' is-invalid' : '' }}" placeholder="Product name">
                                            <i>name</i>
                                        </div>
                                        <br>
                                        {{--  Product Unit  --}}
