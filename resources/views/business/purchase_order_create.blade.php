                        ...
                        <div class="ibox-content">
                            ...
                            <div class="">
                                <form method="post" action="{{ route('business.product.group.store',$institution->portal) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    ...
                                    <hr>
                                    <div class="row">
                                        <table class="table table-bordered" id="purchase_order_table">
                                            <thead>
                                            <tr>
                                                <th>Item Details</th>
                                                <th>Account</th>
                                            ...
                                            <tr>
                                                ...
                                                <td width="10px">
                                                    <span><i data-toggle="tooltip" data-placement="right" title="Remove row." class="fa fa-times-circle fa-2x text-danger"></i></span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
