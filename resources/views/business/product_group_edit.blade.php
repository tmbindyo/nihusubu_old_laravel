...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-4">
        <div class="title-action">
            <a href="#" data-toggle="modal" data-target="#productGroupRegistration" class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> New </a>
        </div>
    </div>
</div>
                        ...
                        <div class="row" id="product_group_attribute">
                            <div class="col-md-6">
                                ...
                                <div class="has-warning">
                                    ...
                                    <span><i data-toggle="tooltip" data-placement="right" title="All transactions related to the items you sell will be displayed in this account" class="fa fa-question-circle"></i></span>
                                    <input type="text" class="form-control input-lg" placeholder="e.g Color">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="has-warning">
                                    <label class="text-danger">Attribute Options</label>
                                    <span><i data-toggle="tooltip" data-placement="right" title="All transactions related to the items you sell will be displayed in this account" class="fa fa-question-circle"></i></span>
                                    <div class="">
                                        <input type="text" class="input-lg" name="attribute_options" id="tag-input">
                                    </div>
                                </div>
                            </div>
                        </div>
...
@include('business.layouts.modals.product_group')
