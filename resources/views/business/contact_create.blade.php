                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        @endif
                                        <div class="has-warning">
                                            <textarea id="about" rows="5" name="about" class="resizable_textarea form-control input-lg {{ $errors->has('about') ? ' is-invalid' : '' }}" required="required" placeholder="About">{{ old('about') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <br>
