        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <strong><a href="{{route('business.invoice.show',['portal'=>$institution->portal,'id'=>$invoice->id])}}">Invoice</a></strong>
                    </li>
                    <li class="active">
                                ...
                                <form method="post" action="{{ route('business.invoice.update',['portal'=>$institution->portal, 'id'=>$invoice->id]) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="has-warning">
                                                ...
                                                @endif
                                                <select name="contact" class="select2 form-control input-lg {{ $errors->has('contact') ? ' is-invalid' : '' }}">
                                            ...
                                            <div class="has-warning" id="data_1">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" value="{{$invoice->date}}" name="date" id="date" class="form-control input-lg {{ $errors->has('date') ? ' is-invalid' : '' }}" required>
                                                </div>
                                                <i> invoice date.</i>
                                </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="has-warning">
                                                ...
                                                <select name="payment_schedule" class="select2_demo_payment_schedule form-control input-lg {{ $errors->has('payment_schedule') ? ' is-invalid' : '' }}">
                                                    ...
                                                    @foreach($paymentSchedules as $paymentSchedule)
                                                        <option @if($invoice->payment_schedule_id == $paymentSchedule->id) selected @endif value="{{$paymentSchedule->id}}"> {{$paymentSchedule->name}} [{{$paymentSchedule->period}}]</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="has-warning" id="data_1">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" value="{{$invoice->due_date}}" name="due_date" id="due_date" class="form-control input-lg {{ $errors->has('due_date') ? ' is-invalid' : '' }}" required>
                                                </div>
                                                <i> due date.</i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="">
                                        <table class="table table-bordered" id = "invoice_table">
                                            ...
                                            @php
                                                $product_index = 0
                                            @endphp
                                            @foreach($invoice->saleProducts as $saleProduct)
                                                <tr>
                                                    <td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            @endif
                                            <textarea required name="customer_notes" placeholder="Notes" class="form-control {{ $errors->has('customer_notes') ? ' is-invalid' : '' }}" rows="7">{{ $invoice->customer_notes }}</textarea>
                                            <i>notes</i>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @endif
                                            <textarea required name="terms_and_conditions" placeholder="Terms and Conditions" class="form-control {{ $errors->has('terms_and_conditions') ? ' is-invalid' : '' }}" rows="7">{{ $invoice->terms_and_conditions }}</textarea>
