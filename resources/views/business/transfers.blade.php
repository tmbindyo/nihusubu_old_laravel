    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-md-3">
            <div class="title-action">
                <a href="{{route('business.transfer.create')}}" class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> Transfer </a>
            </div>
        </div>
    </div>
            ...
            <div class="ibox float-e-margins">
                ...
                @foreach($transfers as $transfer)
                    <tr class="gradeX">
                        ...
                        <td class="text-right">
                            <div class="btn-group">
                                <a href="{{ route('business.transfer.show', $transfer->id) }}" class="btn-white btn btn-xs">View</a>
                                @if($transfer->status_id == "b810f2f1-91c2-4fc9-b8e1-acc068caa03a")
                                    <a href="{{ route('business.transfer.restore', $transfer->id) }}" class="btn-warning btn btn-xs">Restore</a>
                                @else
                                    <a href="{{ route('business.transfer.delete', $transfer->id) }}" class="btn-danger btn btn-xs">Delete</a>
                                @endif
                            </div>
                        </td>
                    </tr>
