    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-6">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{route('business.sales',$institution->portal)}}">Invoices</a>
                </li>
                <li>
                    <a href="{{ route('business.sale.show', ['portal'=>$institution->portal, 'id'=>$sale->id]) }}">Invoice</a>
                </li>
                <li class="active">
                    ...
                    <form class="form-horizontal" method="post" action="{{ route('business.sale.send',['portal'=>$institution->portal,'sale_id'=>$sale->id]) }}">
                        ...
                        <div class="mail-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="subject" type="text" class="form-control {{ $errors->has('subject') ? ' is-invalid' : '' }}" value="Invoice ref #{{$sale->reference}}">
                                </div>
                            </div>
