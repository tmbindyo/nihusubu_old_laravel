    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            <div class="title-action">
                <a href="{{route('business.bill.create')}}" class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> New </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-group">
                                        <a href="{{route('business.bill.show',1)}}" class="btn-primary btn-outline btn btn-xs">View</a>
                                        <a href="{{route('business.bill.edit',1)}}" class="btn-warning btn-outline btn btn-xs">Edit</a>
                                        <a href="{{route('business.bill.delete',1)}}" class="btn-danger btn-outline btn btn-xs">Delete</a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
