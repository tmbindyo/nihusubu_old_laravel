                ...
                <div class="ibox float-e-margins">
                    ...
                    @foreach($categories as $category)
                        <tr class="gradeX">
                            ...
                            <td class="text-right">
                                <div class="btn-group">
                                    <a href="{{ route('business.category', $category->id) }}" class="btn-white btn btn-xs">View</a>
                                    <a href="{{ route('business.category.delete', $category->id) }}" class="btn-danger btn btn-xs">Delete</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
...
@include('business.layouts.modals.category')
