                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-noraml">Collection Name</label>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group" id="data_1">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" required="required" name="date" class="form-control" value="7/27/2019">
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="font-noraml">Tags <span class="required">*</span>
                                            </label>
                                            <select required="required" name="tags[]" class="select2_demo_2 form-control" multiple="multiple">
                                                @foreach($tags as $tag)
                                        ...
                                        <div class="col-md-6">
                                            <label class="font-noraml">Categories <span class="required">*</span>
                                            </label>
                                            <select required="required" name="categories[]" class="select2_demo_2 form-control" multiple="multiple">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group" id="data_1">
                                                <label class="font-noraml">Auto Expiry</label>
                                                <div class="input-group date">
                                                    <span class="input-group-addon">
                                                        <i class="fa fa-calendar"></i>
                                                    </span>
                                                    <input type="text" name="expiry_date" class="form-control" value="7/27/2019">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <label class="font-noraml">Homepage Visibility</label>
