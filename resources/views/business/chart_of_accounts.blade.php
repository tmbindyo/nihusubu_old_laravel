...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-4">
        <div class="title-action">
            <a href="#" data-toggle="modal" data-target="#chartOfAccountsRegistration" class="btn btn-outline btn-primary"><i class="fa fa-plus"></i> New </a>
        </div>
    </div>
</div>
...
@include('business.layouts.modals.chart_of_account_create')
