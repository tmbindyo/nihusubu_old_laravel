            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('business.liability.store',$institution->portal) }}" autocomplete="off" class="form-horizontal form-label-left">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="has-warning">
                                                ...
                                                @endif
                                                <input type="number" id="total" name="total" required="required" readonly value="@if (empty(old(total))) 0 @else {{ old('name') }} @endif" class="form-control input-lg">
                                                <i>total</i>
                                            </div>
                                        </div>
                                    </div>
