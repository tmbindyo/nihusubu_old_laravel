                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-8 b-r">
                                    <p>Edit category.</p>
                                    <form method="post" action="{{ route('business.category.update',$category->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                        @csrf
                ...
                <div class="ibox float-e-margins">
                    ...
                    @foreach($categoryAlbums as $categoryAlbum)
                        <tr class="gradeX">
                            ...
                            <td class="text-right">
                                <div class="btn-group">
                                    <a href="{{ route('business.album', $categoryAlbum->id) }}" class="btn-white btn btn-xs">View</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
