                        ...
                        <form method="post" action="{{ route('project.update', $project) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('priority') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="priority" id="input-priority" class="form-control form-control-alternative{{ $errors->has('priority') ? ' is-invalid' : '' }}" placeholder="{{ __('Priority') }}" value="{{ old('priority', $project->priority) }}" required autofocus readonly>
