...
class AccountController extends Controller
{
    ...
    public function accounts($portal)
    {
        ...
        return view('personal.accounts',compact('accounts','user','institution'));
    }
    ...
    public function accountCreate($portal)
    {
        ...
        return view('personal.account_create',compact('user','institution'));
    }
...
//        return $request;
        ...
        $account->save();
        return redirect()->route('personal.account.show',['portal'=>$institution->portal,'id'=>$account->id])->withSuccess('Expense '.$account->reference.' successfully created!');
    }
    ...
    public function accountShow($portal,$account_id)
    {
        ...
        return view('personal.account_show',compact('account','user','institution','percentage'));
    }
    ...
    public function accountDepositCreate($portal,$account_id)
    {
        ...
        return view('personal.deposit_create',compact('account','user','institution'));
    }
    ...
    public function accountLiabilityCreate($portal,$account_id)
    {
        ...
        return view('personal.account_liability_create',compact('user','institution','account','contacts'));
    }
    ...
    public function accountLoanCreate($portal,$account_id)
    {
        ...
        // get contacts
        $contacts = Contact::with('organization')->where('institution_id',$institution->id)->get();
        return view('personal.account_loan_create',compact('user','institution','account','contacts'));
    }
    ...
    public function accountWithdrawalCreate($portal,$account_id)
    {
        ...
        $account = Account::findOrFail($account_id);
        $account = Account::where('id',$account_id)->where('institution_id',$institution->id)->first();
        return view('personal.withdrawal_create',compact('account','user','institution'));
    }
    ...
    public function accountAdjustmentCreate($portal, $account_id)
    {
        ...
        return view('personal.account_adjustment_create',compact('account','user','institution','accounts'));
    ...
    public function accountAdjustmentEdit($portal)
    {
        ...
        return view('personal.account_adjustment_create',compact('transactions','user','institution','journalsStatusCount','transactions','accounts'));
    ...
    public function accountAdjustmentUpdate(Request $request, $portal)
    {
        ...
        return redirect()->route('personal.transaction.show')->withSuccess('Expense '.$transaction->reference.' successfully updated!');
    ...
    public function depositShow($portal, $deposit_id)
    {
        ...
        return view('personal.deposit_show',compact('deposit','user','institution'));
    }
    ...
    public function depositAccountAdjustmentCreate($portal, $deposit_id)
    {
        ...
        return view('personal.deposit_account_adjustment_create',compact('deposit','account','user','institution','accounts'));
    ...
    public function withdrawalShow($portal, $withdrawal_id)
    {
        ...
        return view('personal.withdrawal_show',compact('withdrawal','user','institution'));
    }
    ...
    public function withdrawalAccountAdjustmentCreate($portal, $withdrawal_id)
    {
        ...
        return view('personal.withdrawal_account_adjustment_create',compact('withdrawal','account','user','institution','accounts'));
    ...
    public function liabilities($portal)
    {
        ...
        return view('personal.liabilities',compact('liabilities','user','institution'));
    }
    ...
    public function liabilityCreate($portal)
    {
        ...
        // get contacts
        $contacts = Contact::with('organization')->where('institution_id',$institution->id)->get();
        return view('personal.liability_create',compact('user','institution','accounts','contacts'));
    }
    ...
    public function liabilityShow($portal, $liability_id)
    {
        ...
        return view('personal.liability_show',compact('accounts','contacts','liability','user','institution'));
    }
    ...
    public function liabilityExpenseCreate($portal, $liability_id)
    {
        ...
        return view('personal.liability_expense_create',compact('liability','campaigns','sales','user','institution','frequencies','expenseAccounts','transfers','expenseStatuses'));
    }
    ...
    public function liabilityUpdate(Request $request, $portal, $liability_id)
    {
        ...
        return redirect()->route('personal.liability.show',$liability->id)->withSuccess('Liability updated!');
    }
    ...
    public function loans($portal)
    {
        ...
        return view('personal.loans',compact('loans','user','institution'));
    }
    ...
    public function loanCreate($portal)
    {
        ...
        // get contacts
        $contacts = Contact::with('organization')->where('institution_id',$institution->id)->get();
        return view('personal.loan_create',compact('user','institution','accounts','contacts'));
    }
    ...
    public function loanShow($portal, $loan_id)
    {
        ...
        return view('personal.loan_show',compact('accounts','contacts','loan','user','institution'));
    }
    ...
    public function loanPaymentCreate($portal, $loan_id)
    {
        ...
        return view('personal.loan_payment_create',compact('user','institution','accounts','loan'));
    }
    ...
    public function loanUpdate(Request $request, $portal, $loan_id)
    {
        ...
        $loan = Loan::findOrFail($loan_id);
        return redirect()->route('personal.loan.show',$loan->id)->withSuccess('Loan updated!');
    ...
    public function transfers($portal)
    {
        ...
        return view('personal.transfers',compact('transfers','user','institution'));
    }
    ...
    public function transferCreate($portal)
    {
        ...
        // get accounts
        $accounts = Account::where('institution_id',$institution->id)->get();
        return view('personal.transfer_create',compact('user','institution','accounts'));
    }
    ...
    public function transferShow($portal, $transfer_id)
    {
        ...
        return view('personal.transfer_show',compact('transfer','user','institution'));
    }
    ...
    public function transferExpenseCreate($portal, $transfer_id)
    {
        ...
        // expense accounts
        $expenseAccounts = ExpenseAccount::where('institution_id',$institution->id)->get();
        return view('personal.transfer_expense_create',compact('transfer','user','institution','journalsStatusCount','expenseStatuses','expenseAccounts'));
    }
    ...
    public function transferUpdate(Request $request, $portal, $transfer_id)
    {
        ...
        return redirect()->route('personal.transfer.show',$transfer->id)->withSuccess('Contact type updated!');
    }
